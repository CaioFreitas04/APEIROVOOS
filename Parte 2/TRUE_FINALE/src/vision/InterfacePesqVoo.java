					...
					if(CheckFt.isSelected()&&CheckEcon.isSelected()) {
						...
						if((!CheckFt.isSelected()&&!CheckEcon.isSelected())) {
							...
							if((CheckFt.isSelected())&&(retorno.qtdFirstClassLivres()>0)) {
								...
								JOptionPane.showMessageDialog(null,"Voo marcado","Chegada ao seu destino : "+DiaN+"/"+"/"+MesN+"/"+AnoN,JOptionPane.ERROR_MESSAGE);
								
							}
							else {
								JOptionPane.showMessageDialog(null,"Sem assentos disponiveis","Nenhuma assentos livre!",JOptionPane.ERROR_MESSAGE);
