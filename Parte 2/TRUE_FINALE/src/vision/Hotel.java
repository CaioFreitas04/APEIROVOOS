...
public class Hotel {
  ...
  public void setStdRooms(int qtdQuartos1pessoa, double precoQuartos1pessoa, int qtdQuartos2pessoa,
    ...
    for (cont = 0; cont < qtdQuartos1pessoa; cont++) {
      StdQuartos1pessoa[cont] = new Quarto(precoQuartos1pessoa, 1, this);
    }
    System.out.println("\nsignal1");
    for (cont = 0; cont < qtdQuartos2pessoa; cont++) {
      StdQuartos2pessoa[cont] = new Quarto(precoQuartos2pessoa, 2, this);
    }
    System.out.println("\nsignal2");
    for (cont = 0; cont < qtdQuartos3pessoa; cont++) {
      StdQuartos3pessoa[cont] = new Quarto(precoQuartos3pessoa, 3, this);
    }
  }
  ...
  public void setPremiumRooms(int qtdQuartos1pessoa, double precoQuartos1pessoa, int qtdQuartos2pessoa,
    ...
    int cont = 0;
    for (cont = 0; cont < qtdQuartos1pessoa; cont++) {
      PremiumQuartos1pessoa[cont] = new Quarto(precoQuartos1pessoa, 1, this);
    }
    for (cont = 0; cont < qtdQuartos2pessoa; cont++) {
      PremiumQuartos2pessoa[cont] = new Quarto(precoQuartos2pessoa, 2, this);
    }
    for (cont = 0; cont < qtdQuartos3pessoa; cont++) {
      PremiumQuartos3pessoa[cont] = new Quarto(precoQuartos2pessoa, 3, this);
    }
  }
